...
public class GattServiceHeartRate {
            ...
            if (heartRateMeasurementValues.flags.rrIntervalPresence == 1) {
                ...
                if (length % 2 == 0) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        heartRateMeasurementValues.rrIntervals[i4] = (int) ((this.mHeartRateMeasurementCharacteristic.getIntValue(18, i2).intValue() / 1024.0d) * 1000.0d);
                        i2 += 2;
                    }
                }
            }
    ...
    public boolean checkService(BluetoothGattService bluetoothGattService) {
        ...
        while (true) {
            ...
            if (uuid.equals(GATT.UUIDs.CHARACTERISTIC_HEART_RATE_MEASUREMENT_UUID) && (next.getProperties() & 16) > 0) {
                ...
                this.mHasClientCharacteristicConfigurationDescriptor = next.getDescriptor(GATT.UUIDs.DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID) != null;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HEART RATE Service ");

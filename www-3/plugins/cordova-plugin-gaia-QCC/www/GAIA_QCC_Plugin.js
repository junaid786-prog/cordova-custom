cordova.define("cordova-plugin-gaia-QCC.GAIA_QCC_Plugin", function(require, exports, module) {
...
module.exports = {
  ...
  Events : {
    ...
    onGAMDataAvailable : function(args) {
      cordova.fireWindowEvent('onGaiaQccGAMDataAvailable', {uuid:args.uuid, timestampMS:args.timestampMS, 
